import{u as d,r as u,b,j as e,H as g}from"./app-jkxT-bAz.js";import{c as x}from"./compiler-runtime-DcROzVuA.js";import{P as h}from"./print-bill-card-D9LpCvLf.js";/* empty css            */import"./utils-D3e9f77r.js";function E(l){const t=x.c(13),{bills:s}=l,a=d().props.auth?.user?.department;let p,o;if(t[0]!==a?(p=()=>{if(a==="finance"){b.visit(route("bills"));return}window.print()},o=[a],t[0]=a,t[1]=p,t[2]=o):(p=t[1],o=t[2]),u.useEffect(p,o),a==="finance")return null;const f=`Print Bills #${s?.length||""}`;let n;t[3]!==f?(n=e.jsx(g,{title:f}),t[3]=f,t[4]=n):n=t[4];let m;t[5]===Symbol.for("react.memo_cache_sentinel")?(m=e.jsx("style",{children:`
                    @media print {
                        @page {
                            size: A4;
                            margin: 8mm;

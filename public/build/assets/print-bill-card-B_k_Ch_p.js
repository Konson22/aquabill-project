import{j as e}from"./app-BvcbtHZ4.js";import{c as j,f as o}from"./utils-BJCfTd35.js";function n({label:t,value:i,className:a,valueClassName:c}){return e.jsxs("div",{className:j("flex justify-between items-center gap-2",a),children:[e.jsxs("span",{className:"font-bold uppercase text-slate-500 whitespace-nowrap",children:[t,":"]}),e.jsx("span",{className:j("font-mono font-bold text-slate-900 truncate bg-gray-100 px-2 text-right flex-1",c),children:i})]})}function _({bill:t}){var p,l,d,m,u;const i=r=>r?new Date(r).toLocaleDateString("en-SS",{year:"numeric",month:"long",day:"2-digit"}):"",a=t==null?void 0:t.customer,c=(()=>{var f;const r=(f=a==null?void 0:a.name)==null?void 0:f.trim();return r?r.split(/\s+/).filter(Boolean).slice(0,3).join(" "):"—"})(),s=t==null?void 0:t.reading,x=(a==null?void 0:a.tariff)||((p=t==null?void 0:t.home)==null?void 0:p.tariff)||{},h=(t==null?void 0:t.consumption)||(s==null?void 0:s.consumption)||0,v=(t==null?void 0:t.current_charge)||0,g=(t==null?void 0:t.fixed_charge)||0,N=(t==null?void 0:t.previous_balance)||0,y=(t==null?void 0:t.total_amount)||0;return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
                    .bill-print-root {
                        position: relative;
                    }

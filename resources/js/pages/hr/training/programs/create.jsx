...
export default function TrainingProgramCreate() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('hr.training.programs.store'));
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Create', href: route('hr.training.programs.create') },
            ]}
        >
            <Head title="New training program" />
                        ...
                        <form onSubmit={submit} className="grid gap-4">
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                <Button type="button" variant="outline" asChild>
                                    <Link href={route('hr.training.programs.index')}>Cancel</Link>
                                </Button>

...
const breadcrumbs = [
    ...
    { title: 'Create', href: '/gis/pipes/create' },
];

export default function PipesCreate({ zones }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('gis.pipes.store'));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create pipe" />
            <div className="mx-auto flex max-w-4xl flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">New pipe</h1>
                        <p className="text-sm text-muted-foreground">Click the map to add polyline vertices (preview updates live).</p>
                    </div>
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="mt-2 text-xs text-muted-foreground">Vertices: {(data.coordinates ?? []).length}</p>
                    </CardContent>
                </Card>

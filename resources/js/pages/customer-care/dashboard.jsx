        ...
        <AppLayout breadcrumbs={[{ title: 'Customer Care Dashboard', href: '/customer-care' }]}>
            ...
            <div className="flex flex-col gap-8 p-4 sm:p-8">
                <div>
                    ...
                    <p className="mt-2 text-slate-500">Handle complaints and customer inquiries.</p>
                </div>
                ...
                <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={ticket.id} className="flex items-center justify-between p-4 rounded-xl bg-slate-50">
                                <div className="flex items-center gap-4">
                                    <div className="h-10 w-10 rounded-full bg-slate-200 flex items-center justify-center font-bold text-slate-600">
                                        {ticket.user[0]}
                                    </div>
                                    <div>
                                        <p className="font-medium text-slate-900">{ticket.topic}</p>
                                ...
                                <div className="text-right flex items-center gap-4">
                                    ...
                                    <span className="text-sm font-medium text-slate-900">{ticket.status}</span>
                                </div>
                            </div>
                        ))}
                    </div>

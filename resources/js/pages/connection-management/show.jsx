...
export default function CustomerDisconnectionStatus({ customer }) {
    ...
    const breadcrumbs = [
        { title: 'Connection management', href: route('disconnections.index') },
        {
            title: customer?.account_number ?? 'Customer',
            href: customer ? route('customers.show', customer.id) : route('disconnections.index'),
        },
        {
            title: 'Disconnection',
            href: customer ? route('customers.disconnection-status', customer.id) : route('disconnections.index'),
        },
    ];

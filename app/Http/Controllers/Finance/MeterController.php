...
use App\Http\Controllers\Concerns\RendersMetersDepartmentOrAdminInertia;
...
class MeterController extends Controller
{
    ...
    use RendersMetersDepartmentOrAdminInertia;
    ...
    public function assign(\App\Models\Customer $home)
    {
        ...
        if (auth()->user()?->department === 'meters') {
            return Inertia::render('meters-readers/meters/assign', $props);
        }

        return $this->renderFinanceOrAdmin('meters/assign', $props);
    }
    ...
    public function index(Request $request)
    {
        ...
        return $this->renderMetersOrAdmin('meters/index', [
            'meters' => $meters,
            'customers' => $customers,
    ...
    public function show($id)
    {
        ...
        return $this->renderMetersOrAdmin('meters/show', [
            'meter' => $meter,
        ]);
    }

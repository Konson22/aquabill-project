...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->renderFinanceOrAdmin('customers/index', [
            'customers' => $customers,
    ...
    public function indexForMeterDepartment(Request $request)
    {
        ...
        return Inertia::render('meters-readers/dashboard/customers/index', [
            'customers' => $customers,
            'filters' => $request->only(['search', 'zone_id', 'area_id', 'tariff_id']),
            'zones' => $zones,
            'areas' => $areas,
...
'.$customerRows.'
    ...
    public function show($id)
    {
        ...
        return $this->renderFinanceOrAdmin('customers/show', [
            'customer' => $customer,

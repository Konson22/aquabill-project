...
class BillController extends Controller
{
    ...
    private function ensureAdminDepartment(): void
    {
        if (Auth::user()->department !== 'admin') {
            abort(403, 'Only admin department users can perform this action.');
        }
    }
    ...
    public function printingList()
    {
        ...
        return Inertia::render('admin/bills/bill-printing-list', [
            'bills' => $bills,
        ]);
    }
    ...
    public function export(Request $request)
    {
        ...
        return response()->streamDownload(function () use ($tariffId, $zoneId) {
            ...
            foreach ($monthlyData as $row) {
                fputcsv($file, [$row['month'], $row['billed'], $row['collected']]);
            }
            fputcsv($file, []);
            ...
            foreach ($zoneData as $row) {
                fputcsv($file, [$row['name'], $row['billed'], $row['collected']]);
            }
    ...
    public function show($id)
    {
        ...
        return $this->renderFinanceOrAdmin('bills/show', [
            'bill' => $bill,
        ]);
    }
    ...
    public function print($id)
    {
        ...
        return Inertia::render('admin/bills/print-single', [
            'bill' => $bill,
        ]);
    }
    ...
    public function bulkPrint(Request $request)
    {
        ...
        return Inertia::render('admin/bills/print-multiple', [
            'bills' => $bills,
        ]);
    }
